...
use Hunter\jwt_auth\Token as EncodedToken;
...
class Policier {
    ...
    public function getKey($public = false) {
        ...
        if (! in_array($alg, ['RS256', 'RS384', 'RS512', 'ES256', 'ES384', 'ES512'])) {
            ...
            if (is_null($keystring)) {
                throw new \Exception("You secret key is invalid.");
            }
    ...
    private function getKeyContents($key) {
        ...
        if (is_null($key)) {
            throw new \Exception("The special your keys path.");
        }
    ...
    public static function __callStatic($method, $args) {
        ...
        throw new \Exception('Method "'.$method.'" not define');
    }
}
